...
export const feedPosts = [
  {
    ...
    pinned: true,
    type: 'Recap',
    title: 'Recap: April 15th, 2026',
    body: '$UNC maintains its center-stage on Crypto Twitter and among Solana-based memecoins...',
    reactions: '82',
  },
  {
    id: 'thesis',
