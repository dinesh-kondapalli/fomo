...
import { type GeneratedWallet, generateWallet } from "@/lib/wallet-keygen";
import { SafeAreaView } from "../lib/safe-area";

export function CreateWalletScreenView({
  onContinue,
}: {
  onContinue: (wallet: GeneratedWallet) => void;
}) {
  ...
  async function handleCreateWallet() {
    ...
    try {
      ...
      try {
        ...
        setChainStatus(
          "BWICK wallet created. Chain node is currently unreachable.",
        );
      }
      onContinue(wallet);
    } catch (err) {
      setError(
        err instanceof Error ? err.message : "Unable to create BWICK wallet",
      );
    } finally {
      setCreating(false);
    }
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.subtitle}>
            Create your wallet and pick a social name.
          </Text>
          ...
          >
            <Text style={styles.primaryText}>
              {creating ? "Creating BWICK wallet..." : "Create wallet"}
            </Text>
          </Pressable>
          ...
          <Text style={styles.terms}>
            Your social name is how others find you in the app.
          </Text>
        </View>
      </SafeAreaView>
    </LinearGradient>
